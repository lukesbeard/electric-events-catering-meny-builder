 ...
 * 2. Start the server: node tripleseat-proxy.js
...
app.use(cors({
  origin: process.env.ALLOWED_ORIGIN || 'https://catering.electriceventsatl.com',
...
app.listen(PORT, () => {
  ...
  console.log(`Allowed origin: ${process.env.ALLOWED_ORIGIN || 'https://catering.electriceventsatl.com'}`);
}); 